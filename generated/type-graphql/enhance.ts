...
const actionResolversMap = {
  Product: {
    ...
    createManyAndReturnProduct: actionResolvers.CreateManyAndReturnProductResolver,
...
const crudResolversInfo = {
  Product: ["aggregateProduct", "createManyProduct", "createManyAndReturnProduct", "createOneProduct", "deleteManyProduct", "deleteOneProduct", "findFirstProduct", "findFirstProductOrThrow", "products", "product", "getProduct", "groupByProduct", "updateManyProduct", "updateOneProduct", "upsertOneProduct"],
...
const argsInfo = {
  ...
  CreateManyAndReturnProductArgs: ["data", "skipDuplicates"],
...
const outputsInfo = {
  ...
  CreateManyAndReturnProduct: ["id", "createdAt", "updatedAt", "name", "sku", "description", "quantity"],
  CreateManyAndReturnCategory: ["id", "createdAt", "updatedAt", "name"],
  CreateManyAndReturnOrder: ["id", "createdAt", "updatedAt", "userId", "customer"],
  CreateManyAndReturnUser: ["id", "createdAt", "updatedAt", "email", "firstName", "lastName", "address"]
};
...
const inputsInfo = {
  ...
  ProductWhereUniqueInput: ["id", "sku", "AND", "OR", "NOT", "createdAt", "updatedAt", "name", "description", "quantity", "categories", "orders"],
  ...
  CategoryWhereUniqueInput: ["id", "AND", "OR", "NOT", "createdAt", "updatedAt", "name", "products"],
  ...
  OrderWhereUniqueInput: ["id", "AND", "OR", "NOT", "createdAt", "updatedAt", "userId", "customer", "products"],
  ...
  UserWhereUniqueInput: ["id", "email", "AND", "OR", "NOT", "createdAt", "updatedAt", "firstName", "lastName", "address", "orders"],
