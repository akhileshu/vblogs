...
const modelsInfo = {
  ...
  User: ["id", "createdAt", "updatedAt", "username", "emailId"],
...
const outputsInfo = {
  ...
  GoalGroupBy: ["id", "createdAt", "updatedAt", "title", "_count", "_avg", "_sum", "_min", "_max"],
  AggregateTechnology: ["_count", "_avg", "_sum", "_min", "_max"],
  TechnologyGroupBy: ["id", "createdAt", "updatedAt", "title", "goalId", "_count", "_avg", "_sum", "_min", "_max"],
  AggregateTopic: ["_count", "_avg", "_sum", "_min", "_max"],
  TopicGroupBy: ["id", "createdAt", "updatedAt", "title", "technologyId", "_count", "_avg", "_sum", "_min", "_max"],
  AggregateTag: ["_count", "_avg", "_sum", "_min", "_max"],
  TagGroupBy: ["id", "createdAt", "updatedAt", "title", "topicId", "_count", "_avg", "_sum", "_min", "_max"],
  AggregateUser: ["_count", "_avg", "_sum", "_min", "_max"],
  UserGroupBy: ["id", "createdAt", "updatedAt", "username", "emailId", "_count", "_avg", "_sum", "_min", "_max"],
  AggregateUserInterest: ["_count", "_avg", "_sum", "_min", "_max"],
  UserInterestGroupBy: ["id", "createdAt", "updatedAt", "userId", "technologyId", "topicId", "interestType", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  AggregateVideo: ["_count", "_avg", "_sum", "_min", "_max"],
  VideoGroupBy: ["id", "createdAt", "updatedAt", "blogId", "videoLink", "thumbnailLink", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  AggregateBlogContent: ["_count", "_avg", "_sum", "_min", "_max"],
  BlogContentGroupBy: ["id", "createdAt", "updatedAt", "intro", "implementation", "advanced", "blogId", "_count", "_avg", "_sum", "_min", "_max"],
  AggregateTagsOnBlogs: ["_count", "_avg", "_sum", "_min", "_max"],
  TagsOnBlogsGroupBy: ["id", "createdAt", "updatedAt", "tagId", "blogId", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  TechnologyAvgAggregate: ["id", "goalId"],
  TechnologySumAggregate: ["id", "goalId"],
  ...
  TopicAvgAggregate: ["id", "technologyId"],
  TopicSumAggregate: ["id", "technologyId"],
  ...
  TagAvgAggregate: ["id", "topicId"],
  TagSumAggregate: ["id", "topicId"],
  ...
  UserCountAggregate: ["id", "createdAt", "updatedAt", "username", "emailId", "_all"],
  UserAvgAggregate: ["id"],
  UserSumAggregate: ["id"],
  UserMinAggregate: ["id", "createdAt", "updatedAt", "username", "emailId"],
  UserMaxAggregate: ["id", "createdAt", "updatedAt", "username", "emailId"],
  UserInterestCountAggregate: ["id", "createdAt", "updatedAt", "userId", "technologyId", "topicId", "interestType", "_all"],
  UserInterestAvgAggregate: ["id", "userId", "technologyId", "topicId"],
  UserInterestSumAggregate: ["id", "userId", "technologyId", "topicId"],
  ...
  BlogAvgAggregate: ["id", "topicId", "authorId", "views", "readTimeInMinutes"],
  BlogSumAggregate: ["id", "topicId", "authorId", "views", "readTimeInMinutes"],
  ...
  VideoAvgAggregate: ["id", "blogId"],
  VideoSumAggregate: ["id", "blogId"],
  ...
  VideoSectionAvgAggregate: ["id", "videoId", "timestampInSeconds"],
  VideoSectionSumAggregate: ["id", "videoId", "timestampInSeconds"],
  ...
  BlogContentAvgAggregate: ["id", "blogId"],
  BlogContentSumAggregate: ["id", "blogId"],
  ...
  TagsOnBlogsAvgAggregate: ["id", "tagId", "blogId"],
  TagsOnBlogsSumAggregate: ["id", "tagId", "blogId"],
  ...
  CreateManyAndReturnUser: ["id", "createdAt", "updatedAt", "username", "emailId"],
...
const inputsInfo = {
  ...
  GoalOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "title", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  TechnologyOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "title", "goalId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  TopicOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "title", "technologyId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  TagOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "title", "topicId", "_count", "_avg", "_max", "_min", "_sum"],
  TagScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "title", "topicId"],
  UserWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "username", "emailId", "Blogs", "interests"],
  UserOrderByWithRelationInput: ["id", "createdAt", "updatedAt", "username", "emailId", "Blogs", "interests"],
  UserWhereUniqueInput: ["id", "username", "emailId", "AND", "OR", "NOT", "createdAt", "updatedAt", "Blogs", "interests"],
  UserOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "username", "emailId", "_count", "_avg", "_max", "_min", "_sum"],
  UserScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "username", "emailId"],
  ...
  UserInterestOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "userId", "technologyId", "topicId", "interestType", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  VideoOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "blogId", "videoLink", "thumbnailLink", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  BlogContentOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "intro", "implementation", "advanced", "blogId", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  TagsOnBlogsOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "tagId", "blogId", "_count", "_avg", "_max", "_min", "_sum"],
  TagsOnBlogsScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "tagId", "blogId"],
  GoalCreateInput: ["createdAt", "updatedAt", "title", "Technologies"],
  GoalUpdateInput: ["createdAt", "updatedAt", "title", "Technologies"],
  GoalCreateManyInput: ["id", "createdAt", "updatedAt", "title"],
  GoalUpdateManyMutationInput: ["createdAt", "updatedAt", "title"],
  TechnologyCreateInput: ["createdAt", "updatedAt", "title", "Topics", "Goal", "userInterests"],
  TechnologyUpdateInput: ["createdAt", "updatedAt", "title", "Topics", "Goal", "userInterests"],
  TechnologyCreateManyInput: ["id", "createdAt", "updatedAt", "title", "goalId"],
  TechnologyUpdateManyMutationInput: ["createdAt", "updatedAt", "title"],
  TopicCreateInput: ["createdAt", "updatedAt", "title", "Technology", "Blogs", "tags", "userInterests"],
  TopicUpdateInput: ["createdAt", "updatedAt", "title", "Technology", "Blogs", "tags", "userInterests"],
  TopicCreateManyInput: ["id", "createdAt", "updatedAt", "title", "technologyId"],
  TopicUpdateManyMutationInput: ["createdAt", "updatedAt", "title"],
  TagCreateInput: ["createdAt", "updatedAt", "title", "Topic", "Blogs"],
  TagUpdateInput: ["createdAt", "updatedAt", "title", "Topic", "Blogs"],
  TagCreateManyInput: ["id", "createdAt", "updatedAt", "title", "topicId"],
  TagUpdateManyMutationInput: ["createdAt", "updatedAt", "title"],
  UserCreateInput: ["createdAt", "updatedAt", "username", "emailId", "Blogs", "interests"],
  UserUpdateInput: ["createdAt", "updatedAt", "username", "emailId", "Blogs", "interests"],
  UserCreateManyInput: ["id", "createdAt", "updatedAt", "username", "emailId"],
  UserUpdateManyMutationInput: ["createdAt", "updatedAt", "username", "emailId"],
  UserInterestCreateInput: ["createdAt", "updatedAt", "interestType", "user", "Technology", "Topic"],
  UserInterestUpdateInput: ["createdAt", "updatedAt", "interestType", "user", "Technology", "Topic"],
  UserInterestCreateManyInput: ["id", "createdAt", "updatedAt", "userId", "technologyId", "topicId", "interestType"],
  UserInterestUpdateManyMutationInput: ["createdAt", "updatedAt", "interestType"],
  BlogCreateInput: ["createdAt", "updatedAt", "skillLevel", "description", "title", "slug", "views", "readTimeInMinutes", "Topic", "Tags", "Author", "content", "Video"],
  BlogUpdateInput: ["createdAt", "updatedAt", "skillLevel", "description", "title", "slug", "views", "readTimeInMinutes", "Topic", "Tags", "Author", "content", "Video"],
  BlogCreateManyInput: ["id", "createdAt", "updatedAt", "topicId", "skillLevel", "authorId", "description", "title", "slug", "views", "readTimeInMinutes"],
  BlogUpdateManyMutationInput: ["createdAt", "updatedAt", "skillLevel", "description", "title", "slug", "views", "readTimeInMinutes"],
  VideoCreateInput: ["createdAt", "updatedAt", "videoLink", "thumbnailLink", "Blog", "Sections"],
  VideoUpdateInput: ["createdAt", "updatedAt", "videoLink", "thumbnailLink", "Blog", "Sections"],
  VideoCreateManyInput: ["id", "createdAt", "updatedAt", "blogId", "videoLink", "thumbnailLink"],
  VideoUpdateManyMutationInput: ["createdAt", "updatedAt", "videoLink", "thumbnailLink"],
  VideoSectionCreateInput: ["createdAt", "updatedAt", "blogSectionTitle", "timestampInSeconds", "blogPart", "Video"],
  VideoSectionUpdateInput: ["createdAt", "updatedAt", "blogSectionTitle", "timestampInSeconds", "blogPart", "Video"],
  VideoSectionCreateManyInput: ["id", "createdAt", "updatedAt", "videoId", "blogSectionTitle", "timestampInSeconds", "blogPart"],
  VideoSectionUpdateManyMutationInput: ["createdAt", "updatedAt", "blogSectionTitle", "timestampInSeconds", "blogPart"],
  BlogContentCreateInput: ["createdAt", "updatedAt", "intro", "implementation", "advanced", "Blog"],
  BlogContentUpdateInput: ["createdAt", "updatedAt", "intro", "implementation", "advanced", "Blog"],
  BlogContentCreateManyInput: ["id", "createdAt", "updatedAt", "intro", "implementation", "advanced", "blogId"],
  BlogContentUpdateManyMutationInput: ["createdAt", "updatedAt", "intro", "implementation", "advanced"],
  TagsOnBlogsCreateInput: ["createdAt", "updatedAt", "Tag", "Blog"],
  TagsOnBlogsUpdateInput: ["createdAt", "updatedAt", "Tag", "Blog"],
  TagsOnBlogsCreateManyInput: ["id", "createdAt", "updatedAt", "tagId", "blogId"],
  TagsOnBlogsUpdateManyMutationInput: ["createdAt", "updatedAt"],
  ...
  TechnologyAvgOrderByAggregateInput: ["id", "goalId"],
  ...
  TechnologySumOrderByAggregateInput: ["id", "goalId"],
  ...
  TopicAvgOrderByAggregateInput: ["id", "technologyId"],
  ...
  TopicSumOrderByAggregateInput: ["id", "technologyId"],
  ...
  TagAvgOrderByAggregateInput: ["id", "topicId"],
  ...
  TagSumOrderByAggregateInput: ["id", "topicId"],
  UserCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "username", "emailId"],
  UserAvgOrderByAggregateInput: ["id"],
  UserMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "username", "emailId"],
  UserMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "username", "emailId"],
  ...
  UserInterestAvgOrderByAggregateInput: ["id", "userId", "technologyId", "topicId"],
  ...
  UserInterestSumOrderByAggregateInput: ["id", "userId", "technologyId", "topicId"],
  ...
  BlogAvgOrderByAggregateInput: ["id", "topicId", "authorId", "views", "readTimeInMinutes"],
  ...
  BlogSumOrderByAggregateInput: ["id", "topicId", "authorId", "views", "readTimeInMinutes"],
  ...
  VideoAvgOrderByAggregateInput: ["id", "blogId"],
  ...
  VideoSumOrderByAggregateInput: ["id", "blogId"],
  ...
  VideoSectionAvgOrderByAggregateInput: ["id", "videoId", "timestampInSeconds"],
  ...
  VideoSectionSumOrderByAggregateInput: ["id", "videoId", "timestampInSeconds"],
  ...
  BlogContentAvgOrderByAggregateInput: ["id", "blogId"],
  ...
  BlogContentSumOrderByAggregateInput: ["id", "blogId"],
  ...
  TagsOnBlogsAvgOrderByAggregateInput: ["id", "tagId", "blogId"],
  ...
  TagsOnBlogsSumOrderByAggregateInput: ["id", "tagId", "blogId"],
  ...
  TechnologyCreateWithoutGoalInput: ["createdAt", "updatedAt", "title", "Topics", "userInterests"],
  ...
  TopicCreateWithoutTechnologyInput: ["createdAt", "updatedAt", "title", "Blogs", "tags", "userInterests"],
  TopicCreateOrConnectWithoutTechnologyInput: ["where", "create"],
  TopicCreateManyTechnologyInputEnvelope: ["data", "skipDuplicates"],
  GoalCreateWithoutTechnologiesInput: ["createdAt", "updatedAt", "title"],
  GoalCreateOrConnectWithoutTechnologiesInput: ["where", "create"],
  UserInterestCreateWithoutTechnologyInput: ["createdAt", "updatedAt", "interestType", "user", "Topic"],
  ...
  GoalUpdateWithoutTechnologiesInput: ["createdAt", "updatedAt", "title"],
  ...
  TechnologyCreateWithoutTopicsInput: ["createdAt", "updatedAt", "title", "Goal", "userInterests"],
  TechnologyCreateOrConnectWithoutTopicsInput: ["where", "create"],
  BlogCreateWithoutTopicInput: ["createdAt", "updatedAt", "skillLevel", "description", "title", "slug", "views", "readTimeInMinutes", "Tags", "Author", "content", "Video"],
  BlogCreateOrConnectWithoutTopicInput: ["where", "create"],
  BlogCreateManyTopicInputEnvelope: ["data", "skipDuplicates"],
  TagCreateWithoutTopicInput: ["createdAt", "updatedAt", "title", "Blogs"],
  TagCreateOrConnectWithoutTopicInput: ["where", "create"],
  TagCreateManyTopicInputEnvelope: ["data", "skipDuplicates"],
  UserInterestCreateWithoutTopicInput: ["createdAt", "updatedAt", "interestType", "user", "Technology"],
  ...
  TechnologyUpdateWithoutTopicsInput: ["createdAt", "updatedAt", "title", "Goal", "userInterests"],
  ...
  TopicCreateWithoutTagsInput: ["createdAt", "updatedAt", "title", "Technology", "Blogs", "userInterests"],
  TopicCreateOrConnectWithoutTagsInput: ["where", "create"],
  TagsOnBlogsCreateWithoutTagInput: ["createdAt", "updatedAt", "Blog"],
  ...
  TopicUpdateWithoutTagsInput: ["createdAt", "updatedAt", "title", "Technology", "Blogs", "userInterests"],
  ...
  BlogCreateWithoutAuthorInput: ["createdAt", "updatedAt", "skillLevel", "description", "title", "slug", "views", "readTimeInMinutes", "Topic", "Tags", "content", "Video"],
  BlogCreateOrConnectWithoutAuthorInput: ["where", "create"],
  BlogCreateManyAuthorInputEnvelope: ["data", "skipDuplicates"],
  UserInterestCreateWithoutUserInput: ["createdAt", "updatedAt", "interestType", "Technology", "Topic"],
  ...
  UserCreateWithoutInterestsInput: ["createdAt", "updatedAt", "username", "emailId", "Blogs"],
  UserCreateOrConnectWithoutInterestsInput: ["where", "create"],
  TechnologyCreateWithoutUserInterestsInput: ["createdAt", "updatedAt", "title", "Topics", "Goal"],
  TechnologyCreateOrConnectWithoutUserInterestsInput: ["where", "create"],
  TopicCreateWithoutUserInterestsInput: ["createdAt", "updatedAt", "title", "Technology", "Blogs", "tags"],
  ...
  UserUpdateWithoutInterestsInput: ["createdAt", "updatedAt", "username", "emailId", "Blogs"],
  ...
  TechnologyUpdateWithoutUserInterestsInput: ["createdAt", "updatedAt", "title", "Topics", "Goal"],
  TopicUpsertWithoutUserInterestsInput: ["update", "create", "where"],
  TopicUpdateToOneWithWhereWithoutUserInterestsInput: ["where", "data"],
  TopicUpdateWithoutUserInterestsInput: ["createdAt", "updatedAt", "title", "Technology", "Blogs", "tags"],
  TopicCreateWithoutBlogsInput: ["createdAt", "updatedAt", "title", "Technology", "tags", "userInterests"],
  TopicCreateOrConnectWithoutBlogsInput: ["where", "create"],
  TagsOnBlogsCreateWithoutBlogInput: ["createdAt", "updatedAt", "Tag"],
  TagsOnBlogsCreateOrConnectWithoutBlogInput: ["where", "create"],
  TagsOnBlogsCreateManyBlogInputEnvelope: ["data", "skipDuplicates"],
  UserCreateWithoutBlogsInput: ["createdAt", "updatedAt", "username", "emailId", "interests"],
  UserCreateOrConnectWithoutBlogsInput: ["where", "create"],
  BlogContentCreateWithoutBlogInput: ["createdAt", "updatedAt", "intro", "implementation", "advanced"],
  BlogContentCreateOrConnectWithoutBlogInput: ["where", "create"],
  VideoCreateWithoutBlogInput: ["createdAt", "updatedAt", "videoLink", "thumbnailLink", "Sections"],
  ...
  TopicUpdateWithoutBlogsInput: ["createdAt", "updatedAt", "title", "Technology", "tags", "userInterests"],
  ...
  UserUpdateWithoutBlogsInput: ["createdAt", "updatedAt", "username", "emailId", "interests"],
  BlogContentUpsertWithoutBlogInput: ["update", "create", "where"],
  BlogContentUpdateToOneWithWhereWithoutBlogInput: ["where", "data"],
  BlogContentUpdateWithoutBlogInput: ["createdAt", "updatedAt", "intro", "implementation", "advanced"],
  VideoUpsertWithoutBlogInput: ["update", "create", "where"],
  VideoUpdateToOneWithWhereWithoutBlogInput: ["where", "data"],
  VideoUpdateWithoutBlogInput: ["createdAt", "updatedAt", "videoLink", "thumbnailLink", "Sections"],
  BlogCreateWithoutVideoInput: ["createdAt", "updatedAt", "skillLevel", "description", "title", "slug", "views", "readTimeInMinutes", "Topic", "Tags", "Author", "content"],
  BlogCreateOrConnectWithoutVideoInput: ["where", "create"],
  VideoSectionCreateWithoutVideoInput: ["createdAt", "updatedAt", "blogSectionTitle", "timestampInSeconds", "blogPart"],
  ...
  BlogUpdateWithoutVideoInput: ["createdAt", "updatedAt", "skillLevel", "description", "title", "slug", "views", "readTimeInMinutes", "Topic", "Tags", "Author", "content"],
  ...
  VideoCreateWithoutSectionsInput: ["createdAt", "updatedAt", "videoLink", "thumbnailLink", "Blog"],
  ...
  VideoUpdateWithoutSectionsInput: ["createdAt", "updatedAt", "videoLink", "thumbnailLink", "Blog"],
  BlogCreateWithoutContentInput: ["createdAt", "updatedAt", "skillLevel", "description", "title", "slug", "views", "readTimeInMinutes", "Topic", "Tags", "Author", "Video"],
  ...
  BlogUpdateWithoutContentInput: ["createdAt", "updatedAt", "skillLevel", "description", "title", "slug", "views", "readTimeInMinutes", "Topic", "Tags", "Author", "Video"],
  TagCreateWithoutBlogsInput: ["createdAt", "updatedAt", "title", "Topic"],
  TagCreateOrConnectWithoutBlogsInput: ["where", "create"],
  BlogCreateWithoutTagsInput: ["createdAt", "updatedAt", "skillLevel", "description", "title", "slug", "views", "readTimeInMinutes", "Topic", "Author", "content", "Video"],
  ...
  TagUpdateWithoutBlogsInput: ["createdAt", "updatedAt", "title", "Topic"],
  BlogUpsertWithoutTagsInput: ["update", "create", "where"],
  BlogUpdateToOneWithWhereWithoutTagsInput: ["where", "data"],
  BlogUpdateWithoutTagsInput: ["createdAt", "updatedAt", "skillLevel", "description", "title", "slug", "views", "readTimeInMinutes", "Topic", "Author", "content", "Video"],
  TechnologyCreateManyGoalInput: ["id", "createdAt", "updatedAt", "title"],
  TechnologyUpdateWithoutGoalInput: ["createdAt", "updatedAt", "title", "Topics", "userInterests"],
  ...
  TopicUpdateWithoutTechnologyInput: ["createdAt", "updatedAt", "title", "Blogs", "tags", "userInterests"],
  UserInterestUpdateWithoutTechnologyInput: ["createdAt", "updatedAt", "interestType", "user", "Topic"],
  ...
  BlogUpdateWithoutTopicInput: ["createdAt", "updatedAt", "skillLevel", "description", "title", "slug", "views", "readTimeInMinutes", "Tags", "Author", "content", "Video"],
  TagUpdateWithoutTopicInput: ["createdAt", "updatedAt", "title", "Blogs"],
  UserInterestUpdateWithoutTopicInput: ["createdAt", "updatedAt", "interestType", "user", "Technology"],
  TagsOnBlogsCreateManyTagInput: ["id", "createdAt", "updatedAt", "blogId"],
  TagsOnBlogsUpdateWithoutTagInput: ["createdAt", "updatedAt", "Blog"],
  ...
  BlogUpdateWithoutAuthorInput: ["createdAt", "updatedAt", "skillLevel", "description", "title", "slug", "views", "readTimeInMinutes", "Topic", "Tags", "content", "Video"],
  UserInterestUpdateWithoutUserInput: ["createdAt", "updatedAt", "interestType", "Technology", "Topic"],
  TagsOnBlogsCreateManyBlogInput: ["id", "createdAt", "updatedAt", "tagId"],
  TagsOnBlogsUpdateWithoutBlogInput: ["createdAt", "updatedAt", "Tag"],
  VideoSectionCreateManyVideoInput: ["id", "createdAt", "updatedAt", "blogSectionTitle", "timestampInSeconds", "blogPart"],
  VideoSectionUpdateWithoutVideoInput: ["createdAt", "updatedAt", "blogSectionTitle", "timestampInSeconds", "blogPart"]
};
